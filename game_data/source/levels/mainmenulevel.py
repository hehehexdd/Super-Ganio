...
class MainMenu(Level):
    def __init__(self, instance):
        ...
        main_menu_widget = Widget((screen_size[0] / 2, 250), 50, 40, "Super Ganio!", 100)
        play_menu_widget = Widget((self.game_instance.window.get_window_size()[0] / 2, 250), 50, 40, "Select a map", 100)
